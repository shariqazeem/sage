...
const LIVE: Item[] = [
  ...
  { title: "A grant priced in J$, paid in two milestones on the private rail", body: "J$1,600 in two milestones, each released when its evidence verified and escrowed behind a commitment; settled 6 September, in a rehearsal with our own wallet standing in for the seller.", how: "the vault looks the reward up · the claim is the money", href: "/proof/0x2337afda7ef311c4bd515d66feb78f0903f16b3cc23e49ef7fb7702fe1bb54", cta: "the receipt" },
  { title: "A working-capital advance, disbursed and repaid", body: "$1.85 drawn against verified inflow twelve minutes after the first payout, repaid in full by the waterfall from the next one, the same day.", how: "capacity = 1× monthly verified inflow · 50% of each next payout", href: "/record/0x04f1f6530f84e4a1db7fa35bafc313174a2482a54c775c4321487eb0fe91f434", cta: "the record" },
