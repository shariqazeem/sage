...
const RECORD = "0x41c4F9c6D5Bd1D970975436a875E94049D0e7699";
      ...
      <section>
        ...
        <div className="tbl"><table>
          ...
          <tbody>
            ...
            <tr><td>First working-capital advance disbursed and repaid from the next payout</td><td><span className="status proven">proven · 6 Sep</span></td><td><Link href="/record/0x04f1f6530f84e4a1db7fa35bafc313174a2482a54c775c4321487eb0fe91f434">the recipient&apos;s record</Link> — $1.85 drawn against verified inflow twelve minutes after the first payout, repaid in full from the second one eight minutes later{o.advancesTotal > 0 ? ` · ${o.advancesTotal} advance${o.advancesTotal === 1 ? "" : "s"}, ${o.advancesRepaid} repaid` : ""}</td></tr>
            <tr><td>First obligation priced in a Caribbean currency, settled</td><td><span className="status proven">proven · 6 Sep</span></td><td>a J$1,600 grant in two milestones of J$800, each released on the private rail when its evidence verified — a rehearsal with our own wallet standing in for the seller, every step on the public ledger · <Link href="/proof/0x72838f509d6dae3e570e6536167c166f06d4a92f68fce849c10fe1b29983f8">receipt one</Link> · <Link href="/proof/0x2337afda7ef311c4bd515d66feb78f0903f16b3cc23e49ef7fb7702fe1bb54">receipt two</Link></td></tr>
          </tbody>
        </table></div>
      </section>
